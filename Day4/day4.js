const arr = [
  1, 3, 54, 712, 52, 904, 113, 12, 135, 32, 31, 56, 23, 79, 611, 123, 677, 232,
  997, 101, 111, 123, 2, 7, 24, 57, 99, 45, 666, 42, 104, 129, 554, 335, 876,
  35, 15, 93, 13,
];
...
for (let i = 0; i < sortedArr.length; i++) {
  ...
  for (let j = 0; j < filteredArray.length - 1; j = j + 2) {
    sum += filteredArray[j + 1] - filteredArray[j];
  }
  console.log(sortedArr[i], sum);
}
